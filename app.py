...
# --- Your existing insert_preference function (keep exactly as is) ---
...
def show_navigation():
    ...
    st.sidebar.title("📅 Room Allocator Navigation")
    
    st.sidebar.markdown("""
    **📑 Pages:**
    - **🏠 Home** - General info & submit preferences
    ...
    st.sidebar.info(f"**Current Office Time:**\n{now_local.strftime('%Y-%m-%d %H:%M:%S')}\n({OFFICE_TIMEZONE_STR})")
...
def main():
    ...
    # --- Information Section (your existing info) ---
    st.info("""
    💡 **How This Works:**
